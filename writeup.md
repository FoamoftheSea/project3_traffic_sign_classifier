...
The data was mean centered and std normalized featurwise using the functionality available through the ImageDataGenerator class in Keras by fitting it to the training set.
